...
public class NavigationModeController implements Dumpable {
    ...
    private final class LLUVIASettingsObserver extends ContentObserver {
        public LLUVIASettingsObserver(Handler handler) {
            super(handler);
        }
    ...
    private LLUVIASettingsObserver mSettingsObserver;
    ...
    public NavigationModeController(Context context,
        ...
        mSettingsObserver = new LLUVIASettingsObserver(new Handler());
