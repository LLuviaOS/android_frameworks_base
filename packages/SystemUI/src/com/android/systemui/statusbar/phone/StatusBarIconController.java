...
import com.android.systemui.lluvia.LLuviaSettingsService;
...
public interface StatusBarIconController {
    ...
    public static class DarkIconManager extends IconManager {
        ...
        protected void destroy() {
            ...
            Dependency.get(LLuviaSettingsService.class).removeObserver(this);
        }
     ...
     */
    public static class IconManager implements DemoMode, LLuviaSettingsService.LLuviaSettingsObserver {
        ...
        protected StatusBarMobileView addMobileIcon(int index, String slot, MobileIconState state) {
            ...
            mGroup.addView(view, index, onCreateLayoutParams());
            Dependency.get(LLuviaSettingsService.class).addIntObserver(this, Settings.System.USE_OLD_MOBILETYPE);
