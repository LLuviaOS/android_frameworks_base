...
public class SoundSearchTile extends QSTileImpl<BooleanState> {
    ...
    public void handleClick() {
        ...
        // Shazam
        if (lluviaUtils.isPackageInstalled(mContext, "com.shazam.android") || lluviaUtils.isPackageInstalled(mContext, "com.shazam.encore.android")) {
            Intent intent = new Intent(Intent.ACTION_MAIN);
            intent.setAction("com.shazam.android.intent.actions.START_TAGGING");
            mContext.startActivity(intent);
        // Soundhound
        } else if (lluviaUtils.isPackageInstalled(mContext, "com.melodis.midomiMusicIdentifier.freemium") || lluviaUtils.isPackageInstalled(mContext, "com.melodis.midomiMusicIdentifier")) {
            Intent intent = new Intent(Intent.ACTION_MAIN);
            intent.setAction("com.soundhound.android.ID_NOW_EXTERNAL");
            mContext.startActivity(intent);
        // Google Search Music
        } else if (lluviaUtils.isPackageInstalled(mContext, "com.google.android.googlequicksearchbox")) {
            Intent intent = new Intent(Intent.ACTION_MAIN);
