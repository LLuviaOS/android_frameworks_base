...
public class QSFooterImpl extends FrameLayout implements QSFooter,
    ...
    public boolean onLongClick(View v) {
        if (v == mSettingsButton) {
            startTormentaActivity();
            mVibrator.vibrate(30);
        }
        return false;
    }

    private ComponentName TORMENTA_SETTING_COMPONENT = new ComponentName(
            "com.android.settings", "com.android.settings.Settings$TormentaSettingsActivity");

    private void startTormentaActivity() {
        mActivityStarter.startActivity(new Intent().setComponent(TORMENTA_SETTING_COMPONENT),
                true /* dismissShade */);
    }
